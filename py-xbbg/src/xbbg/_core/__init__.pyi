...
class ArrowColumn:
    ...
    def slice(self, offset: builtins.int = 0, length: typing.Optional[builtins.int] = None) -> ArrowColumn: ...
    def compact(self) -> ArrowColumn:
        r"""
        Copy logical values into independent, right-sized Arrow buffers.
        """
    def to_pylist(self) -> typing.Any: ...
...
class ArrowRecordBatch:
    ...
    def __arrow_c_array__(self, requested_schema: typing.Optional[typing.Any] = None) -> tuple: ...
    ...
    def __getitem__(self, column: typing.Any) -> ArrowColumn: ...
    def select(self, columns: typing.Any) -> ArrowRecordBatch: ...
    def slice(self, offset: builtins.int = 0, length: typing.Optional[builtins.int] = None) -> ArrowRecordBatch: ...
    def compact(self) -> ArrowRecordBatch:
        r"""
        Copy logical values into independent, right-sized Arrow buffers.
        """
    def __len__(self) -> builtins.int: ...
...
class ArrowTable:
    ...
    def compact(self) -> ArrowTable:
        r"""
        Copy logical values into independent, right-sized Arrow buffers.
        """
    def tail(self, n: builtins.int) -> ArrowTable: ...
    def sort_by(self, sort_keys: typing.Sequence[tuple[builtins.str, builtins.str]], *, nulls_last: builtins.bool = True) -> ArrowTable: ...
...
class PyEngineConfig:
    ...
    def subscription_pool_size(self, value: builtins.int) -> None:
        ...
        """
    @property
    def runtime_worker_threads(self) -> builtins.int:
        r"""
        Tokio worker threads used by this Engine (default: 2)
        """
    @runtime_worker_threads.setter
    def runtime_worker_threads(self, value: builtins.int) -> None:
        r"""
        Tokio worker threads used by this Engine (default: 2)
        """
    @property
    def max_subscription_sessions(self) -> builtins.int:
        r"""
        Maximum concurrently allocated subscription sessions (default: 32)
        """
    @max_subscription_sessions.setter
    def max_subscription_sessions(self, value: builtins.int) -> None:
        r"""
        Maximum concurrently allocated subscription sessions (default: 32)
        """
    @property
